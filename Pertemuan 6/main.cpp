...
int main(int argc, char** argv){
    ...
    graph.setNumNodes(6);
    // tambahkan nodes
    graph.addNode(0, 2, 0.9f);
    graph.addNode(1, 1, 0.45f);
    graph.addNode(2, 1, 0.7f);
    graph.addNode(3, 2, 0.60f);
    graph.addNode(4, 3, 0.8f);
...
//	BFS(graph, startIdx);
    ...
    glutCreateWindow("RIYAN ADI SAPUTRO / 2000018286 - PRAKTIKUM STIMA");
