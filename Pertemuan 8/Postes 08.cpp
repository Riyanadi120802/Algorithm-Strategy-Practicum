...
void BBRecursive(int rootIdx, int startIdx, int levelIdx,
Graph graph, bool visited[], vector<int> path, vector<float> costMatrix[], float costRoot){
	// inisialisasi
...
void BB(int startIdx, Graph graph){
	...
	for (int i=0; i<pathSequence.size();i++){
		...
		finalDistance += graph.getNodeDistance()[pathSequence.at(i-
...
int main(int argc, char** argv){
	...
	glutCreateWindow("RIYAN ADI SAPUTRO / 2000018286 - Postest 08 SA");
