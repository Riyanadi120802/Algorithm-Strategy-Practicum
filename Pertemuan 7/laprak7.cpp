...
bool assignColor(int nodeIdx, vector<bool> adjStatus[], int colorList[],
int colorIdx){
...
int main(int argc, char** argv){
	...
	graph.addNode(1, 1, 1.2f);
	graph.addNode(2, 2, 1.2f);
	graph.addNode(3, 0, 1.2f);
	graph.addNode(4, 0, 1.2f);
	// tambahkan edge
	graph.addEdge(0, 1);
	graph.addEdge(0, 2);
	graph.addEdge(0, 3);
	...
	glutCreateWindow("Riyan Adi Saputro / 2000018286 - PRAKTIKUM SA");
